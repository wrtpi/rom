...
[ -f configs/config_rk3328 ] && echo -e '\nCONFIG_KERNEL_BUILD_USER="Tony CN"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by Tony"' >> configs/config_rk3328
[ -f configs/config_h5 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="Tony CN"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by Tony"' >> configs/config_h5
[ -f configs/config_h3 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="Tony CN"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by Tony"' >> configs/config_h3
